   ...
   <div class="row">
     <div class="col-sm-3">
       <div id="mySidenav" class="sidenav">
    	...
    	<div class="col-sm-7 mt-5">
    		 <form action="codepartment.php" method="post">
    ...
    <tbody>
      <tr>
        ...
        <td><a href="deletedepartment.php?id=<?php echo $row ['dept_id'];?>">delete</a></td>
        <td><a href="editdepartment.php?id=<?php echo $row['dept_id'];?>">edit</a></td>
      </tr>
    </tbody>
    <?php
    $a++;
